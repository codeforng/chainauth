              ...
              <TabPanel width={'full'}>
                {isSubmitted ? (
                  ...
                  <form id="my-form" onSubmit={submitHandler}>
                    ...
                    ></textarea>
                    <button className="submit-btn btn btn-primary bg-purple-500 mt-4" type="submit">
                      Import
                    </button>
                  </form>
                )}
              ...
              <TabPanel width={'full'}>
                {isSubmitted ? (
                  ...
                  <form id="my-form" onSubmit={submitHandler}>
                    ...
                    <input
                      className="w-[90vw] md:w-[70vw] h-10 border-purple-500 border-2 py-2 px-4 outline-none rounded-md"
